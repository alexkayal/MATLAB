%   Algorithm
%   
%   1. Calculate entry points. Default method: price close beyond EMA50.
...
% getting the MA's %
mov1F = tsmovavg(TS,'s',1);
mov2F = tsmovavg(TS,'s',7);
...
YMatrix = [type' mx rx sx TP*10000 swipe*10000];
