...
% getting the large MA's %
mov100F = tsmovavg(TS,'s',100);
mov200F = tsmovavg(TS,'s',200);
mov100_m = fts2mat (mov100F.CLOSE);
mov200_m = fts2mat (mov200F.CLOSE);
